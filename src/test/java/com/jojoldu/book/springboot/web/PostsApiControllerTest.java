...
public class PostsApiControllerTest {
    // JPA 기능 까지 한번에 테스트할 때는 @SpringBootTest와 TestRestTemplate을 사용
    ...
    @Before
    public void setup(){ // 매번 테스트가 시작되기 전에 MockMvc 인스턴스를 생성
    ...
    @Test
    @WithMockUser(roles = "USER") // 인증된 모의 사용자를 만들어서 사용. role에 권한을 추가 할 수 있음.
